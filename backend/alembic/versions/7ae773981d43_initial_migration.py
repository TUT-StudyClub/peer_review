...
def upgrade() -> None:
    ...
    op.create_table('submission_rubric_scores',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('submission_id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_submission_rubric_scores_criterion_id'), 'submission_rubric_scores', ['criterion_id'], unique=False)
    op.create_index(op.f('ix_submission_rubric_scores_submission_id'), 'submission_rubric_scores', ['submission_id'], unique=False)
    ...
    op.create_table('ta_review_requests',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('assignment_id', sa.Uuid(), nullable=False),
    sa.Column('submission_id', sa.Uuid(), nullable=False),
    sa.Column('teacher_id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_ta_review_requests_review_assignment_id'), 'ta_review_requests', ['review_assignment_id'], unique=False)
    ...
    op.create_table('review_rubric_scores',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('review_id', sa.Uuid(), nullable=False),
    sa.Column('criterion_id', sa.Uuid(), nullable=False),
    sa.Column('score', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_review_rubric_scores_criterion_id'), 'review_rubric_scores', ['criterion_id'], unique=False)
